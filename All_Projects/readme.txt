OPENCV_INCLUDE_DIR : $(SolutionDir)External\opencv430\include
...
OPENCV_LIBS_DIR : $(SolutionDir)External\opencv430\x64\vc16\lib
OPENCV_DLLS_DIR : $(SolutionDir)External\opencv430\x64\vc16\bin
OUTPUT_DIR : $(SolutionDir)Output\$(Platform)\Binaries\$(ProjectName)

Npc_BIN : $(SolutionDir)NpcLibraries\Bin

For define DllExport : _IMAGE_PROCESSING_TOOLS_EXPORT_
...
450:
opencv_core450d.lib;opencv_imgproc450d.lib;opencv_imgcodecs450d.lib;opencv_highgui450d.lib;opencv_videoio450d.lib

430:
opencv_core430d.lib;opencv_imgproc430d.lib;opencv_imgcodecs430d.lib;opencv_highgui430d.lib;opencv_videoio430d.lib
